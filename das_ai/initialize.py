...
def load_data(
    ...
    g.ax_joint.set_yticks([500,600,700,800])
    g.fig.set_size_inches(7, 6.5)
    # g.ax_joint.tick_params(axis='x', labelsize=20)
    ax_joint = g.ax_joint
    ...
    g.ax_marg_x.tick_params(length=7, width=2)
